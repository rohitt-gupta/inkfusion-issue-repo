      ...
      <div>
        <div className="relative isolate">
          ...
          >
            ...
            -translate-x-0.5 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#d387fd] opacity-30 sm:left-[calc(50%-30rem)]
            sm:w-[72.1875rem]"
            />
          </div>
          <div>
          ...
          >
            ...
            -translate-x-0.5 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#d387fd] opacity-30 sm:left-[calc(50%-36rem)]
            sm:w-[72.1875rem]"
            />
          </div>
        </div>
          ...
          <li className="md:flex-1 ">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 ">
              ...
              <span className="mt-2 text-zinc-700 ">
                Either starting out with a free plan or our{" "}
                <Link
                  href="/pricing"
